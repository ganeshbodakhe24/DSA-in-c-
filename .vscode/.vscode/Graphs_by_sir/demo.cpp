...
// problem is theat if there is we are unable to define is circuit is forming or not
//  the visited array is not sufficient to defin that the circuit is forming or not (pn kam bhagty);
#include <iostream>
using namespace std;
